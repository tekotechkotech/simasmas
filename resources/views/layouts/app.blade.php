...
<head>
    ...
    <style>
        ...
        .nav-link:hover i { color: var(--sidebar-active-color); }
        .nav-link.active {
            color: var(--sidebar-active-color);
            background-color: var(--sidebar-active-bg);
            font-weight: 600;
        }
        .nav-link.active i { color: var(--sidebar-active-color); }
        ...
        /* Content Styling */
        .content { padding: 1.5rem 2rem; flex-grow: 1; }
        ...
        @media (max-width: 768px) {
            ...
            .sidebar.active { margin-left: 0; box-shadow: 4px 0 15px rgba(0,0,0,0.05); }
        ...
        <nav class="sidebar" id="sidebar">
            ...
            <div class="sidebar-nav">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item mt-3 mb-1 px-3 text-uppercase text-muted" style="font-size: 0.7rem; font-weight: 700; letter-spacing: 0.5px;">Menu Utama</li>
                    ...
                    <div class="dropdown">
                        <a href="#" class="d-flex align-items-center text-decoration-none text-dark dropdown-toggle" id="dropdownUser" data-bs-toggle="dropdown" aria-expanded="false">
                            <div class="d-none d-sm-block text-end me-2">
                                ...
                                <div class="text-muted" style="font-size: 0.75rem;">{{ ucwords(str_replace('_', ' ', auth()->user()->role)) }}</div>
                            </div>
                            <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name) }}&background=2563eb&color=fff" alt="User" width="36" height="36" class="rounded-circle border border-2 border-white shadow-sm">
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end border-0 shadow-sm mt-2 rounded-3" aria-labelledby="dropdownUser">
                            <li><a class="dropdown-item py-2" href="#"><i class="far fa-user me-2 text-muted"></i> Profil Saya</a></li>
                            <li><a class="dropdown-item py-2" href="#"><i class="fas fa-cog me-2 text-muted"></i> Pengaturan</a></li>
