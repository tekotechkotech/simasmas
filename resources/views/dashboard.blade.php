                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start justify-content-between">
                            <div>
                                ...
                                <h3 class="fw-bold mb-0 text-dark">Rp {{ number_format($totalKas, 0, ',', '.') }}</h3>
                            </div>
                        ...
                        <div class="mt-3">
                            <span class="badge bg-emerald-light text-emerald rounded-pill"><i
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start justify-content-between">
                            <div>
                                ...
                                <h3 class="fw-bold mb-0 text-dark">{{ $kegiatanBulanIni }}</h3>
                            </div>
                        ...
                        <div class="mt-3">
                            <a href="#" class="text-decoration-none small text-indigo fw-medium">Lihat Kalender <i
            ...
            <div class="col-xl-3 col-sm-6 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            <a href="#" class="text-decoration-none small text-amber fw-medium">Cek Kondisi Barang <i
                                    class="fas fa-arrow-right ms-1"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex flex-wrap gap-2 gap-md-3">
                            <a href="{{ route('keuangan.create', ['jenis' => 'pemasukan']) }}"
                                class="btn btn-light-action px-3 py-2 rounded-3"><i
                                    class="fas fa-hand-holding-usd text-emerald me-2"></i>Terima Infaq</a>
                            <a href="{{ route('keuangan.create', ['jenis' => 'pengeluaran']) }}"
                                class="btn btn-light-action px-3 py-2 rounded-3"><i
                                    class="fas fa-file-invoice-dollar text-danger me-2"></i>Catat Pengeluaran</a>
                            <button class="btn btn-light-action px-3 py-2 rounded-3 text-decoration-none"><i
                                    class="fas fa-user-plus text-sky me-2"></i>Daftar Jamaah</button>
                            <button class="btn btn-light-action px-3 py-2 rounded-3 text-decoration-none"><i
                                    class="fas fa-bullhorn text-indigo me-2"></i>Buat Pengumuman</button>
                            <button class="btn btn-light-action px-3 py-2 rounded-3 text-decoration-none"><i
                                    class="fas fa-print text-muted me-2"></i>Cetak Laporan</button>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        @if($kegiatanTerdekat->isEmpty())
                            ...
                            <div class="text-center py-5">
                                ...
                                <a href="{{ route('kegiatan.create') }}"
                                    class="btn btn-outline-primary btn-sm rounded-pill px-4">Buat Kegiatan</a>
                            </div>
                        @else
            ...
            <div class="col-xl-4 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-body p-0">
                        ...
                        @else
                            <div class="list-group list-group-flush">
                                @foreach($transaksiTerakhir as $trans)
                                    <div class="list-group-item px-3 py-3 d-flex justify-content-between align-items-center">
                                        <div>
                                            <small
                                                class="fw-bold d-block">{{ $trans->keterangan ?? ucfirst($trans->kategori) }}</small>
                                            <small
                                                class="text-muted">{{ \Carbon\Carbon::parse($trans->tanggal)->format('d M') }}</small>
                                        </div>
                                        <span class="fw-bold {{ $trans->jenis == 'pemasukan' ? 'text-success' : 'text-danger' }}">
                                            {{ $trans->jenis == 'pemasukan' ? '+' : '-' }}Rp
                                            {{ number_format($trans->nominal, 0, ',', '.') }}
                                        </span>
                                    </div>
                                @endforeach
                            </div>
